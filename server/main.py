...
# The perimeter -- security headers, the received-bytes body bound, CORS and
# the two flat error shapes -- lives in http_guards, installed in one call so
# its order is stated once. MAX_BODY_BYTES is re-exported for the tests.
http_guards.install(app, get_settings().cors_origin_list)
